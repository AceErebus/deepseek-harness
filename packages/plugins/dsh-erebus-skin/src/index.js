// dsh-erebus-skin host half: serves the skin media (liang video + portraits)
// over /plugins/dsh-erebus-skin/assets/* with byte-range support (video
// scrubbing needs 206 responses). Ported from the liang-intensity-skin plugin.
...
export const PACKAGE_ID = "dsh-erebus-skin";
